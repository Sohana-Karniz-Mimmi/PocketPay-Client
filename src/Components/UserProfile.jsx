...
import avatar from '../assets/images/cute-girl-avatar.avif'
...
const UserProfile = () => {
    ...
    return (
        <div className="w-3/5 mx-auto p-8 bg-white shadow-lg rounded-lg">

            <div className="w-96 px-6 py-6  text-center border border-rose-300 rounded-lg lg:mt-0 xl:px-10 mx-auto">
                <div className="space-y-4 xl:space-y-6">
                    <div className="avatar mt-10 mb-3">
                        <div className="w-36 rounded-full ">
                            <img src={userInfo.profilePicture} alt="author avatar" />
                        </div>
                    </div>
                    <div className='!-mt-0.5'>

                        <button className='py-1 pt-1.5 uppercase px-4 text-xs text-white bg-[#FF0143] rounded-full'>
                            {role.role}
                        </button>
                    </div>
                    ...
                    <div className="!mt-2">
                        <div className="flex justify-center items-center flex-col text-lg font-medium leading-6">
                            ...
                            <p className=" text-indigo-300"><strong>Email:</strong> {userInfo.email}</p>
                            <div className="flex justify-center mt-5 space-x-5"><a href="#" rel="noopener noreferrer"
                                className="inline-block text-gray-400"><span className="sr-only">Twitter</span><svg
                                    ...
                                    className="w-6 h-6 text-gray-400 hover:text-[#FF0143]" height="1em" width="1em"
                                ...
                                </svg></a><a href="#" rel="noopener noreferrer"
